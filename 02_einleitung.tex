...
Ziel des Projekts ist es, eine anwendungsspezifische Sprache (domain-specific language)\todo{DSL einführen} zu entwicklen und anhand dieser Code einer höheren Programmiersprache zu generieren.
